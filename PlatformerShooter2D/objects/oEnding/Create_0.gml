...
if (global.hasgun == true) && (global.kills > 0)
{
	...
	endtext[1] = "But some of those people had guns too, so...";
		if (global.kills == 1) endtext[1] = "But that guy also had a gun, so..."
	endtext[2] = "He was probably saving the world, or something";
	endtext[3] = "Regardless, he was arrested two days later spent the rest of his life in prision.";
	endtext[4] = "The defense team tried to argue that the sexy recoil effects and hit flashes were to blame, \nbut to no avail.";
	endtext[5] = "The park ranger would later state sha was \"not angry, just dissapointed. \"";
	endtext[6] = "The end.";
...
else
{
	...
	endtext[1] = "They reported a discarded firearm to the local authorities\nand were thanked profusely for assisting in an ongoing crime";
	endtext[2] = "And all it took was a behavior that outside of a vide game context\none would hope is completly normal";
